...
public class TimingUtils {
	...
	/**
	 * A map that relates an Amalthea {@link org.eclipse.app4mc.amalthea.model.TimeUnit} to its equivalent
	...
	/**
	 * A map that relates a {@link java.util.concurrent.TimeUnit} to 
	 * assigned integer constants. These constants match the index of
	 * the corresponding string in {@value Constants#TIME_UNIT_OPTIONS}
	 * @return The map of Java time units to constants
	 * @see Constants#TIME_UNIT_OPTIONS
	 */
	public static HashMap<java.util.concurrent.TimeUnit, Integer> timeToConstantMap(){
		HashMap<java.util.concurrent.TimeUnit, Integer> map = new HashMap<>();
		map.put(java.util.concurrent.TimeUnit.NANOSECONDS, 3);
		map.put(java.util.concurrent.TimeUnit.MICROSECONDS, 2);
		map.put(java.util.concurrent.TimeUnit.MILLISECONDS, 1);
		map.put(java.util.concurrent.TimeUnit.SECONDS, 0);
		return map;
	}
	
	/**
	 * Gets a mapping of periodic tasks to their period
	 * @param model An Amalthea {@link org.eclipse.app4mc.amalthea.model.SWModel} to be read from
